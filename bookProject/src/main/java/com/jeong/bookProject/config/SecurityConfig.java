package com.jeong.bookProject.config;
...
import com.jeong.bookProject.config.auth.PrincipalDetailService;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.and()
				...
				.defaultSuccessUrl("/book/searchForm"); // 스프링 시큐리티가 해당 주소로 요청오는 로그인을 가로채서 대신 로그인 해준다.
	}
}
